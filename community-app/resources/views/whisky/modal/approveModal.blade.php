<div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="postModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group mt-2 mb-2">
              <label class="fs-6 fw-bold ms-1 mb-2" for="region-category">지역별</label>
            ...
            <div class="form-group mt-2 mb-2">
              <label class="fs-6 fw-bold ms-1 mb-2" for="material-category">재료별</label>
            ...
            <div class="form-group mt-2 mb-2">
              <label class="fs-6 fw-bold ms-1 mb-2" for="alcohol">도수 (숫자만 입력)</label>
              <input class="form-control mb-2" value={{ $whisky->alcohol }} type="text" name="alcohol">
            </div>
            <div class="form-group mt-2 mb-2">
              <label class="fs-6 fw-bold ms-1 mb-2" for="content">추가 기재사항</label>
