...
const LoginPage = () => {
  ...
  return (
    <div className="mt-4 w-1/2 flex bg-white rounded-lg shadow border mb-4">
      <div className="p-6 space-y-4 flex-1">
        ...
        <div className="flex justify-center">
          <div
            className="w-3/4 text-white bg-black hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
