    ...
    return(
        <header className="bg-white shadow-sm bg-slate-300">
            <div className="mx-auto max-w-[2024px] px-0 md:px-12 lg:px-11 xl:px-16">
                <div className="grid h-24 grid-cols-3 max-lg:grid-cols-2 max-sm:grid-col1 items-center justify-between gap-3">
                    <a href="/" className="flex items-center space-x-1 max-lg:justify-self-center">
                        <Image
                    ...
                    <nav className="flex space-x-10 justify-self-center max-lg:hidden">
                        ...
                        <a href="/login" className="text-xl text-black hover:text-gray-500">Login</a>
